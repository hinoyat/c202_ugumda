...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query(value = "SELECT * FROM users WHERE isDeleted = 'N' AND userSeq != :userSeq ORDER BY RAND() LIMIT 1", nativeQuery = true)
    Optional<User> findRandomActiveUserExceptSelf(@Param("userSeq") Integer userSeq);
